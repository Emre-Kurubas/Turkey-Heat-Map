...
- [x] **Step 1: Install React and the testing harness**
...
- [x] **Step 2: Enable JSX and CSS Modules in `tsconfig.json`**
...
- [x] **Step 3: Add a CSS-Modules type declaration**
...
- [x] **Step 4: Configure Vite for React, CSS Modules, and the playground**
...
- [x] **Step 5: Split the Vitest config into `core` and `ui` projects**
...
- [x] **Step 6: Create the jsdom setup file**
...
- [x] **Step 11: Create the playground app**
...
- [x] **Step 12: Add the playground script**
...
- [x] **Step 13: Verify the whole toolchain**
...
- [x] **Step 14: Ignore playground output and commit**
...
- [x] **Step 5: Write `src/styles/index.ts`**
...
- [x] **Step 3: Write `src/i18n/types.ts`**
...
- [x] **Step 5: Write `src/i18n/index.ts`**
...
- [x] **Step 1: Confirm Vite inlines the TopoJSON**
...
- [x] **Step 4: Implement `src/data/geo/topology.ts`**
...
- [x] **Step 5: Write the barrel `src/data/geo/index.ts`**
...
- [x] **Step 7: Check what the geometry costs the bundle**
...
- [x] **Step 3: Implement `src/context/HeatMapStore.ts`**
...
- [x] **Step 4: Implement `src/context/HoverStore.ts`**
...
- [x] **Step 6: Implement the subscription hooks**
...
- [x] **Step 7: Write the provider test**
...
- [x] **Step 4: Implement `useResizeObserver`**
